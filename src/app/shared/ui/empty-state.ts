...
@Component({
  ...
  template: `
    <div class="flex flex-col items-center justify-center p-8 md:p-12 text-center rounded-xl bg-surface-50 dark:bg-surface-800 border border-dashed border-surface-200 dark:border-surface-700">
      ...
      @if (actionLabel()) {
        <button type="button" class="inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-emerald-700 transition-colors" (click)="action.emit()">
